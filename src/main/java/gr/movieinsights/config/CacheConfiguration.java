...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, gr.movieinsights.domain.Movie.class.getName() + ".images");
            ...
            createCache(cm, gr.movieinsights.domain.Person.class.getName() + ".images");
            ...
            createCache(cm, gr.movieinsights.domain.Credit.class.getName() + ".images");
            createCache(cm, gr.movieinsights.domain.BannedEntity.class.getName());
            createCache(cm, gr.movieinsights.domain.BannedPersistentEntity.class.getName());
            ...
            createCache(cm, gr.movieinsights.domain.Image.class.getName());
