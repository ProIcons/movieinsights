 ...
 */
public class MovieInsightsPerGenreDTO extends MovieInsightsPerGenreBasicDTO implements IMovieInsightsContainerExtendedDTO {
    @Override
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MovieInsightsPerGenreDTO)) return false;

        MovieInsightsPerGenreDTO that = (MovieInsightsPerGenreDTO) o;
