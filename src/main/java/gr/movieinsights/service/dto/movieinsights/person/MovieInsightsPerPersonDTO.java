 ...
 */
public class MovieInsightsPerPersonDTO extends MovieInsightsPerPersonBasicDTO implements IMovieInsightsContainerExtendedDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MovieInsightsPerPersonDTO)) return false;

        MovieInsightsPerPersonDTO that = (MovieInsightsPerPersonDTO) o;
