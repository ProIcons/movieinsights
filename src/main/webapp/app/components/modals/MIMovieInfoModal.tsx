...
import {TmdbUtils} from "app/utils";
...
export class MIMovieInfoModal extends MIBaseLoadableCard<MIMovieInfoModalProps, MIMovieInfoModalState, IMovie> {
  constructor(props) {
