  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="movieInsightsApp.genre.home.createOrEditLabel">
            <Translate contentKey="movieInsightsApp.genre.home.createOrEditLabel">Create or edit a Genre</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : genreEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tmdbIdLabel" for="genre-tmdbId">
