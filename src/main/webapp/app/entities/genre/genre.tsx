...
import { getSearchEntities, getEntities } from './genre.reducer';
...
export const Genre = (props: IGenreProps) => {
  ...
  const { genreList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="genre-heading">
        <Translate contentKey="movieInsightsApp.genre.home.title">Genres</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="movieInsightsApp.genre.home.createLabel">Create new Genre</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('movieInsightsApp.genre.home.search')}
                />
        ...
        {genreList && genreList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('tmdbId')}>
                  <Translate contentKey="movieInsightsApp.genre.tmdbId">Tmdb Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="movieInsightsApp.genre.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="movieInsightsApp.genre.home.notFound">No Genres found</Translate>
            </div>
          )
        )}
      </div>
