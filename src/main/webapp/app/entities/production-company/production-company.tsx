  ...
  return (
    <div>
      <h2 id="production-company-heading">
        <Translate contentKey="movieInsightsApp.productionCompany.home.title">Production Companies</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="movieInsightsApp.productionCompany.home.createLabel">Create new Production Company</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('movieInsightsApp.productionCompany.home.search')}
                />
      ...
      <div className="table-responsive">
        {productionCompanyList && productionCompanyList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
            ...
            <tbody>
              {productionCompanyList.map((productionCompany, i) => (
                <tr key={`entity-${i}`}>
                  <td>
                    <Button tag={Link} to={`${match.url}/${productionCompany.id}`} color="link" size="sm">
                      {productionCompany.id}
                    </Button>
                  </td>
                  <td>{productionCompany.name}</td>
                  <td>{productionCompany.tmdbId}</td>
                  <td>{productionCompany.logoPath}</td>
                  <td>{productionCompany.originCountry}</td>
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${productionCompany.id}`} color="info" size="sm">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="movieInsightsApp.productionCompany.home.notFound">No Production Companies found</Translate>
            </div>
          )
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductionCompany);
