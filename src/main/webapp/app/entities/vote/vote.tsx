...
import { getSearchEntities, getEntities } from './vote.reducer';
...
export const Vote = (props: IVoteProps) => {
  ...
  const { voteList, match, loading } = props;
  return (
    <div>
      <h2 id="vote-heading">
        <Translate contentKey="movieInsightsApp.vote.home.title">Votes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="movieInsightsApp.vote.home.createLabel">Create new Vote</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('movieInsightsApp.vote.home.search')}
                />
        ...
        {voteList && voteList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="movieInsightsApp.vote.home.notFound">No Votes found</Translate>
            </div>
          )
        )}
      </div>
