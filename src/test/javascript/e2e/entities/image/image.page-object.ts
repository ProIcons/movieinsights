...
export class ImageDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('movieInsightsApp.image.delete.question'));
...
export default class ImageComponentsPage {
  ...
  async deleteImage() {
    ...
    expect(await imageDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/movieInsightsApp.image.delete.question/);
