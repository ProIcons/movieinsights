...
export class PersonDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('movieInsightsApp.person.delete.question'));
...
export default class PersonComponentsPage {
  ...
  async deletePerson() {
    ...
    expect(await personDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/movieInsightsApp.person.delete.question/);
